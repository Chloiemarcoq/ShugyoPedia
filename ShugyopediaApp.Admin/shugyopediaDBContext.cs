...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Addr=localhost\\SQLEXPRESS; database=shugyopediaDB; Trusted_Connection=True;MultipleActiveResultSets=true;TrustServerCertificate=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasIndex(e => e.TopicName, "UQ__Topics__6C795E8CF40A1195")
                    .IsUnique();
            ...
            modelBuilder.Entity<TopicResource>(entity =>
            {
                entity.HasKey(e => e.ResourceId)
                    .HasName("PK__TopicRes__4ED1816FDB6272EB");
            ...
            {
                entity.HasIndex(e => e.UserId, "UQ__Users__1788CCADD10F122C")
                    .IsUnique();
